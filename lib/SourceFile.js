...
SourceFile.prototype = {
    ...
    addSection: function(name, segment, bank, offset) {
        // TODO find existing sections with default offsets and the same segment / bank and alias them
        this.currentSection = new Section(this, name, segment, bank, offset);
        this.sections.push(this.currentSection);
    },

    addBinaryInclude: function(src) {
        this.binaryIncludes.push(new Binary(this, src.value, this.currentSection));
    },
    ...
    addDataBlock: function(values, isByte, size, line, col) {
        ...
        this.dataBlocks.push(new Data(values, this.currentSection, isByte, size));
