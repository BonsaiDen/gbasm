...
SourceFile.prototype = {
    ...
    section: function(name, segment, bank, offset) {
        ...
        this.currenSection = new Section(this, name, segment, bank, offset);
        this.sections.push(this.currenSection);
        this.offset = this.currenSection.offset;
    ...
    variable: function(name, size, line, col) {
        ...
        // Only add offset if the size is already available
    ...
    binary: function(src) {
        var binary = new Binary(this, src.value, this.offset, this.currenSection);
        this.binaries.push(binary);
        this.offset += binary.size;
