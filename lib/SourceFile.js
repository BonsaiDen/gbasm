...
SourceFile.prototype = {
            ...
            if (instr.arg) {
                ...
                // Convert signed values to twos complement
                    ...
                    if (instr.bits === 8) {
                        ...
                        if (instr.arg.value === 'loop_dma') {
                            console.log(instr.mnemonic, instr.arg, value.toString(16));
                        }
    ...
    list: function() {
        ...
        var lines = this.instructions.map(function(i) {
            ...
            return padHexValue(i[1], 4, '0') + ' ' + padr(bytes.map(function(value) {
                return padHexValue(value, 2, '0');
    ...
    include: function(file, line, col) {
        ...
        // Parse the file
        var includedFile = this.compiler.include(this, file, this.offset, this.offsetSection, line, col);
        this.includes.push(includedFile);
        this.offsetSection = includedFile.offsetSection;
    ...
    instruction: function(mnemonic, cycles, code, arg, isByte, isSigned, isBit, line, col) {
        ...
        var instr = new Instruction(
            mnemonic, this.offset, this.offsetSection,
    ...
    section: function(name, segment, offset) {
        ...
        this.offsetSection = new Section(name, segment, offset);
        this.sections.push(this.offsetSection);
        this.offset = offset;
    },
    ...
    variable: function(name, size, line, col) {
        ...
        this.variables.push(new Variable(this, name, this.offset, this.offsetSection, size, line, col));
        this.offset += size;
    ...
    label: function(name, parent, line, col) {
        ...
        var label = new Label(this, name, this.offset, this.offsetSection, parent, line, col);
    ...
    data: function(values, isByte, size, line, col) {
        ...
        var data = new Data(values, this.offset, this.offsetSection, isByte, size);
...
Section.prototype = {
    ...
    updateOffsets: function() {
        ...
        this.code.forEach(function(entry) {
