...
Compiler.prototype = {
    ...
    generate: function() {
        ...
        var rom = Generator.generateRom(this.files);
        ...
        // Warnings
        rom.isPadded && this.log(null, 'Generated ROM is b than size specified in header, padding.');
    ...
    warning: function(file, index, message) {
        ...
        !this.silent && console.warn(file.getPath().orange + ' ' + message.yellow);
    },
