...
Compiler.prototype = {
    ...
    mapping: function() {
        ...
        function row(from, to, free, used) {
        ...
        var map = segmentList.map(function(segment) {
            ...
            segment.usage.forEach(function(u, index) {
                ...
                usage.push(row(u[0], u[0] + u[1] - 1, u[1], true));
    ...
    resolve: function(sourceFile, value, sourceOffset, sourceIndex, relativeOffset, stack) {
        ...
        switch(value.type) {
            ...
            case 'NAME':
                resolved = this.resolveName(value.value, sourceFile);
                if (resolved) {
                    ...
                    if (value.value[0] === '_') {
                        ...
                        var resolvedGlobal = this.resolveName(value.value, sourceFile, true);
                        if (resolvedGlobal) {
    ...
    sortSections: function() {
        ...
        // Sort sections based on their offsets
    ...
    alignSections: function() {
        ...
        sections.forEach(function(section) {
            ...
            console.log(section.resolvedOffset);
