    ...
    function SourceFileProxy(section) {
        ...
        this.addSection = function(name) {
            new Errors.ParseError(
                this,
                'SECTION, cannot be declared within a macro delcaration',
                null,
                name.index
            );
        };

        // TODO how to handle, labels, constants and variables?
        // TODO make local file local ones local to the macros scope?
