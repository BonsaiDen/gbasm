...
Parser.prototype = {
    ...
    parse: function() {
        ...
        while((this._token = this.stream.next())) {
            ...
            switch(this._token.type) {
                ...
                default:
                    this.error(this._token.type, null, this._token.index);
                    break;
    ...
    parseDS: function(s) {
        ...
        if (s.peak('EXPRESSION')) {
            this.file.addDataBlock([s.expect('EXPRESSION')], true, size, this._token.index);

        } else if (s.peak('STRING')) {
            this.file.addDataBlock([s.expect('STRING')], true, size, this._token.index);
    ...
    parseInstruction: function(s, mnemonic) {
        ...
        switch(mnemonic) {
            ...
            case 'ldh':
                ...
                // ldh a,?
                    ...
                    // ldh a,$ff
                        ...
                        this.instruction(12, [0xF0], s.expect('NUMBER_8BIT'), true);
                    }

                // ldh $ff,a
                } else {
                    this.instruction(12, [0xE0], s.expect('NUMBER_8BIT'), true);
                }
            ...
            case 'ldhl':
                ...
                s.expect(',');
                this.instruction(12, [0xF8], s.expect('NUMBER_8BIT'), true);
                break;
            ...
            case 'cp':
                ...
                // cp $ff
                    ...
                    }[mnemonic]], s.expect('NUMBER_8BIT'), true);
                }
                break;
            ...
            case 'jp':
                ...
                // jp label
                    ...
                    this.instruction(16, [0xC3], s.expect('NUMBER_16BIT'));
                }
                break;
            ...
            case 'call':
                ...
                // call label
                    ...
                    this.instruction(24, [0xCD], s.expect('NUMBER_16BIT'));
                }
                break;
    ...
    parseLdInstruction: function(s) {
        ...
        if (s.peak('ACCUMULATOR')) {
            ...
            // ld a,$f
                ...
                this.instruction(8, [0x3E], s.expect('NUMBER_8BIT'), true);
            }
        ...
        // Memory stores
            ...
            // ld [hl],$ff
                ...
                // ld [hl],$ff
                    ...
                    this.instruction(8, [0x36], s.expect('NUMBER_8BIT'), true);
                }
        ...
        // Stackpointer load
            ...
            // ld sp,someLabel
                ...
                this.instruction(12, [0x31], s.expect('NUMBER_16BIT'));
            }
        ...
        // ld d,$ff
            ...
            // ld c,$ff etc.
                ...
                }[left]], s.expect('NUMBER_8BIT'), true);
            }
        }
    ...
    parseAddSubInstruction: function(s, mnemonic) {
        ...
        // add SP,4
            ...
            s.expect('REGISTER_SP');
            s.expect(',');
            this.instruction(16, [0xE8], s.expect('NUMBER_SIGNED_8BIT'), true, true);
        ...
        // sbc a|b|c|d|e|h|l
            ...
            // sbc a,r8
            if (s.peak('REGISTER_8BIT')) {
                var arg = s.expect('REGISTER_8BIT');
                switch(mnemonic) {
                    case 'add':
                        this.instruction(4, [{
                            a: 0x87,
    ...
    parseBitInstruction: function(s, mnemonic) {
        ...
        var left = s.expect('NUMBER_BIT_INDEX').value,
        ...
        // set 0-7,a|b|c|d|e|h|l
            ...
            var right = s.expect('REGISTER_8BIT');
            if (mnemonic === 'bit') {
                this.instruction(8, [0xCB, {
                    a: 0x47,
                    b: 0x40,
