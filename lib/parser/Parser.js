...
Parser.prototype = {
        ...
        while((this._token = this.stream.next())) {
            ...
            switch(this._token.type) {
                ...
                case 'LABEL_LOCAL_DEF':
                    if (!this._label) {
                        this.file.parseError('local label without parent label', null, this._token.index);
                    }
                ...
                default:
                    this.file.parseError(this._token.type, null, this._token.index);
                    break;
    ...
    parseName: function(s, name) {
        ...
        if (s.peak('EQU')) {
            ...
            if (value !== null) {
                this.file.addConstant(name.value, value, false, name.index);
            }
            ...
            if (value !== null) {
                this.file.addConstant(name.value, value, true, name.index);
            }

        } else {
            this.file.parseError(name.type, null, name.index);
        }
    ...
    parseDirective: function(s, token) {
        ...
        switch(token.value) {
            ...
            default:
                this.file.parseError(this._token.value, null, this._token.index);
                break;
    ...
    parseDS: function(s) {
        ...
        if (s.peak('EXPRESSION')) {
            this.file.addDataBlock([s.expect('EXPRESSION')], true, size);

        } else if (s.peak('STRING')) {
            this.file.addDataBlock([s.expect('STRING')], true, size);
