...
Parser.prototype = {
    ...
    parseLabel: function(s, label) {
        ...
        if (s.peak('DS')) {
            ...
            this.file.variable(label.value, size, label.line, label.col);
    ...
    parseDirective: function(s, token) {
        ...
        switch(token.value) {
            ...
            case 'SECTION':
                ...
                this.file.section(name, segment, bank, offset);
                break;
                ...
                if (s.peak('STRING')) {
                    while((value = s.expect('STRING'))) {
                        ...
                        if (s.peak(',')) {
                            ...
                            this.file.data(values, true, null);
                            values = [];
                            break;
                        }
            ...
            case 'DW':
                while((value = s.expect('NUMBER_16BIT'))) {
                    ...
                    if (s.peak(',')) {
                        ...
                        this.file.data(values, false, null);
                        values = [];
                        break;
                    }
