...
Expression.prototype = {
    ...
    parseBinary: function(p) {
        ...
        // Now we collect additional binary operators on right as long as their precedence
        // is higher then the initial one
    ...
    parseUnary: function() {
        ...
        // Values / Calls
            ...
            throw new TypeError('Unexpected token when evaluating expression');
        }
    ...
    prec: function(op) {
        ...
        switch (op) {
            ...
            case '==': // TODO not implemented in lexer
            case '!=': // TODO not implemented in lexer
                return 6;
